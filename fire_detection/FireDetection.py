...
from color_detection.ColorDetection import Color_Detection,Setup_Plotter,ExtractFrame,Plot_Graph
from flicker_detection.MotionDetection import Background_Subtraction,VideoSetup,Resize_Frame,Setup_Parameters
